...
console.log(!(n2 > n1 || n2 > n3)); // OR + NOT, nesse caso é falso com verdadeiro, porque o NOT está negando a primeira operação, o NOT nesse caso só pega a primeira operação, se eu quiser que ele pegue as duas operações eu preciso colocar (), como no caso abaixo
